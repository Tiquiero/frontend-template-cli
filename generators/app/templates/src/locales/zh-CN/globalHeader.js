export default {
  ...
  'component.globalHeader.rightContent.globalHeaderRight.development': '开发模式',
  'component.globalHeader.rightContent.globalHeaderRight.scene': '场景模式',
  'component.globalHeader.avatarDropdown.logout': '退出登录',

  'component.globalHeader.rightContent.globalHeaderRight.project': '当前项目：',
};
